  ...
  return (
    < >
      ...
      <div className="body-content container-fluid">
        <div className="body_head d-flex align-items-center">
          <h1 className="">Gembucket1111</h1>
          <i type="button" data-toggle="modal" data-target="#exampleModalLong" className="fa-solid fa-pen"></i>
        </div>
